...
![Пример сценария работы с облачной системой сборки: 1) загрузка исходных текстов, 2) построение main.exe, 3) модификация util.c и пересборка](../img/make1.svg){#fig:make1}
...
![Пример графа зависимостей задач](../img/make2.svg){#fig:make2}
